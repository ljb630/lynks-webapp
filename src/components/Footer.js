        ...
        <div>
            ...
            <div className="flex items-center justify-between bg-[#02060c] px-[17.5%] py-[4rem]">
                <div className="text-white flex items-center">
                    <span className="ml-3 text-lg font-semibold">Lynks @2023</span>
                </div>
                <div className="text-white">Made in India with Love 
                    <a href="https://www.linkedin.com/in/chahatbhatia18/" className="font-semibold text-[#A51515]" target="_blank"> Lynks Team</a>
                </div>
            </div>
        </div>
    )
