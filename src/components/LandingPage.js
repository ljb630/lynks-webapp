...
const LandingPage = () => {
    ...
    const searchLocations = async (searchQuery) => {
        ...
        const {data} = {
			...
			"data": [
			  ...
			  {
				"description": "Bengaluru Palace, Bengaluru, Karnataka, India",
			  ...
			  {
				"description": "Benz Circle, Vijayawada, Andhra Pradesh, India",
				"place_id": "ChIJc_bYUb_6NToRCTO7L3gZz6s",
				"types": [
				  "sublocality_level_1",
				  "sublocality",
				  "political",
				...
				"structured_formatting": {
				  ...
				  "secondary_text": "Vijayawada, Andhra Pradesh, India"
				}
			  },
			  {
				"description": "Benares, Uttar Pradesh, India",
				"place_id": "ChIJTc_rb7ctjjkRtfA_hRAXE2g",
				"types": [
				  "locality",
				  "political",
				  "geocode"
			  ...
			  {
				"description": "Benaulim Beach, Benaulim, Goa",
				"place_id": "ChIJg15sBGy0vzsRh092Ust9yHk",
				"types": [
				  "natural_feature",
				  "establishment"
				],
				...
				"structured_formatting": {
				  ...
				  "secondary_text": "Benaulim, Goa"
				}
			  }
			],
			"tid": "7eec3836-f02c-4b69-aa90-360bf324a888",
			"sid": "b1q0bb6c-a267-4f27-a3c7-78a8c1826b71",
			"deviceId": "1e7cd0a8-e535-a089-7609-0d861541a0cc",
			"csrfToken": "ATcrX1kNy8es-kAHjt84JSK1mVAj7jQxdJ0jEZss"
		  }
    ...
    const handleFetchLatLong = async (placeId) => {
        ...
        const data = {"statusCode":0,"data":
		[{"formatted_address":"Benz Circle, Vijayawada, Andhra Pradesh 520010, India","address_components":
		[{"long_name":"Benz Circle","short_name":"Benz Circle","types":["locality"]},{"long_name":"Vijayawada","short_name":"Vijayawada","types":["city"]},{"long_name":"Andhra Pradesh","short_name":"AP","types":["state"]},{"long_name":"India","short_name":"IN","types":["country"]},{"long_name":"520010","short_name":"520010","types":["postal_code"]}],"place_id":"ChIJc_bYUb_6NToRCTO7L3gZz6s","geometry":{"location":{"lat":16.4956621,"lng":80.6542015},"location_type":"APPROXIMATE","viewport":{"northeast":{"lat":16.4970110802915,"lng":80.65555048029151},"southwest":{"lat":16.4943131197085,"lng":80.6528525197085}}},"types":["political","sublocality","sublocality_level_1","DEFAULT"],"place_type":"Others"}],"tid":"7eec3836-f02c-4b69-aa90-360bf324a888","sid":"b1q0bb6c-a267-4f27-a3c7-78a8c1826b71","deviceId":"1e7cd0a8-e535-a089-7609-0d861541a0cc","csrfToken":"NhsouErvgxIN-zDa_F_v7_YQA1ZqjQtQXTUGx-hI"}
