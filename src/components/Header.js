...
import logoSvg from "../assets/top-logo.jpeg"
                        ...
                        <li className={`mr-[60px] font-semibold ${offerstMatch && "text-[#fc8019]"} hover:text-[#fc8019] group`}>
                            <Link className="flex" to="/offers-near-me">
                                <span className="mr-2.5">
                                    <svg className={`fill-[#3d4152] ${offerstMatch && "fill-[#fc8019]"} group-hover:fill-[#fc8019]`} viewBox="0 0 32 32" height="19" width="19" fill="#686b78">
